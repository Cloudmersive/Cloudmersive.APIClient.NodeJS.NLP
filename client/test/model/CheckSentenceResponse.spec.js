...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveNlpApiClient.CheckSentenceResponse();
  });
  ...
  describe('CheckSentenceResponse', function() {
    it('should create an instance of CheckSentenceResponse', function() {
      // uncomment below and update the code to test CheckSentenceResponse
      //var instane = new CloudmersiveNlpApiClient.CheckSentenceResponse();
      //expect(instance).to.be.a(CloudmersiveNlpApiClient.CheckSentenceResponse);
    });
