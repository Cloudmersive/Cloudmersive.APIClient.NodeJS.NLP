...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveNlpApiClient.CorrectWordInSentence();
  });
  ...
  describe('CorrectWordInSentence', function() {
    it('should create an instance of CorrectWordInSentence', function() {
      // uncomment below and update the code to test CorrectWordInSentence
      //var instane = new CloudmersiveNlpApiClient.CorrectWordInSentence();
      //expect(instance).to.be.a(CloudmersiveNlpApiClient.CorrectWordInSentence);
    });
