...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveNlpApiClient.CheckWordResponse();
  });
  ...
  describe('CheckWordResponse', function() {
    it('should create an instance of CheckWordResponse', function() {
      // uncomment below and update the code to test CheckWordResponse
      //var instane = new CloudmersiveNlpApiClient.CheckWordResponse();
      //expect(instance).to.be.a(CloudmersiveNlpApiClient.CheckWordResponse);
    });
